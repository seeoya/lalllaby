  ...
  최초 업로드 2020. 05. 30. / 최종 수정 2020. 06. 02.
  https://github.com/seeoya/lalllaby
  둘이서 수사(후타리소우사, 후타소사) Roll20 커스텀 시트 html/css 백업
  
  개인이 사용하기 위해 제작한 시트이며, 문제 발생 시 수정 및 삭제됩니다.
  크롬/웨일 브라우저에 최적화되어있으며, 외의 브라우저에서는 원활히 작동하지 않습니다.
  전문가가 작성한 코드가 아님을 유의해주세요.
 
  문의/오류 신고/수정 제안은 @TQ_Romantic 의 DM으로 부탁드립니다.
